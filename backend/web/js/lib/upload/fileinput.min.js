...
!function (e) {
    ...
    t = ".fileinput", i = "kvFileinputModal", a = 'style="width:{width};height:{height};"', n = '<param name="controller" value="true" />\n<param name="allowFullScreen" value="true" />\n<param name="allowScriptAccess" value="always" />\n<param name="autoPlay" value="false" />\n<param name="autoStart" value="false" />\n<param name="quality" value="high" />\n', r = '<div class="file-preview-other">\n<span class="{previewFileIconClass}">{previewFileIcon}</span>\n</div>', l = window.URL || window.webkitURL, o = function (e, t, i) {
        ...
        constructor: me, _init: function (t) {
            ...
            var t, i = this;
            return i.$errorContainer.find("li").length ? !0 : (t = e(document.createElement("div")).html(i.$errorContainer.html()), t.find("span.kv-error-close").remove(), t.find("ul").remove(), e.trim(t.text()).length ? !0 : !1)
                ...
                if (!ae(r) && void 0 !== l) {
                    ...
                    v = parseInt(v.replace("init_", "")), p = ae(m.config) && ae(m.config[v]) ? null : m.config[v], u = ae(p) || ae(p.extra) ? i : p.extra, "function" == typeof u && (u = u()), s = {
                        ...
                        success: function (e, i, r) {
                            ...
                            })) : (s.jqXHR = r, s.response = e, t._showError(e.error, s, "filedeleteerror"), f.removeClass("file-uploading"), n.removeClass("disabled"),
                                void a())
                        },
            ...
            l.formdata = new FormData, 0 !== s && c && !l._abort(d) && (r = function () {
                ...
                var n = l._getOutData(a, t), o = l._getThumbs(), s = 0, d = ae(t) || ae(t.errorkeys) ? [] : t.errorkeys;
            ...
            a.loadedImages = [], a.totalImagesCount = 0, e.each(t, function (e, t) {
                ...
                return 0 !== A || ae(L) || !ne(L) || ae(D) || (k = o(I, D), A += ae(k) ? 0 : k.length, 0 !== A) ? a.showPreview ? !w && P > h ? (d.addClass("file-thumb-loading"), a._previewDefault(S, $), a._initFileActions(), a._updateFileDetails(m), void i(e + 1)) : (r.length && void 0 !== FileReader ? (c.html(p.replace("{index}", e + 1).replace("{files}", m)), d.addClass("file-thumb-loading"), s.onerror = function (e) {
                    a._errorHandler(e, I)
                }, s.onload = function (t) {
